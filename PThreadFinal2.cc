...
int ExternalConstraint  = INT_MAX;
...
void *sender(void *i){
    ...
    while  (1) {
          ...
          if (retval == EOK) {
              ...
              if (PrevReciever == PredicateVar1){
                  ExternalConstraint = PredicateVar2;
              } else if (PrevReciever == PredicateVar2){
                  ExternalConstraint = PredicateVar3;
              } else if (PrevReciever == PredicateVar3){
